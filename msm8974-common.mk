...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/android.hardware.sensor.accelerometer.xml:s$(TARGET_COPY_OUT_VENDOR)/etc/permissions/android.hardware.sensor.accelerometer.xml \
